...
import com.happybluefin.pay.google.Base64;
import com.happybluefin.pay.google.Base64DecoderException;
...
public class Security {
	public static String googleBase64EncodedPublicKey;
	...
	public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData,
		...
		if (!TextUtils.isEmpty(signature)) {
			 ...
			 */
			String base64EncodedPublicKey = googleBase64EncodedPublicKey;
